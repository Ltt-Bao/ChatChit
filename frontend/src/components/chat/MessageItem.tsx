...
import type { Conversation, Participant } from "@/type/chat";
...
const MessageItem = ({message, index, messages, selectedConvo, lastMessageStatus} : MessageItemProps) => {
  ...
  return (
    ...
    > 
        ...
        >
            <Card className={cn("p-3", message.isOwn ? "bg-chat-bubble-sent border-0 text-primary-foreground" : "bg-chat-bubble-received" )}>
